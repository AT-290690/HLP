...
const MAX_KEY = 10
export const collections: Record<string, Interpretion> = {
  ['>>']: (args, env) => {
    if (args.length !== 2)
  ...
  ['.:cartesian_product']: (args, env) => {
    if (args.length !== 1)
      throw new RangeError(
        'Invalid number of arguments to .: cartesian_product []'
      )
    const array = evaluate(args[0], env)
    if (!Inventory.isBrrr(array))
      throw new TypeError(
        'First argument of .: cartesian_product [] must be an .: []'
      )
  ...
  ['.:adjacent_difference>>']: (args, env) => {
    if (args.length < 1 || args.length > 2)
      throw new RangeError(
        'Invalid number of arguments to .: adjacent_difference >> []'
      )
    const array = evaluate(args[0], env)
    if (!Inventory.isBrrr(array))
      throw new TypeError(
        'First argument of .: adjacent_difference >> [] must be an .: []'
      )
    const callback = args[1] ? evaluate(args[1], env) : undefined
    if (callback != undefined && typeof callback !== 'function')
      throw new TypeError(
        'Second argument of .: adjacent_difference >> must be a -> []'
      )
  ...
  ['.:adjacent_find>>']: (args, env) => {
    if (args.length < 1 || args.length > 2)
      throw new RangeError(
        'Invalid number of arguments to .: adjacent_find >> []'
      )
    const array = evaluate(args[0], env)
    if (!Inventory.isBrrr(array))
      throw new TypeError(
        'First argument of .: adjacent_find >> must be an .: []'
      )
    const callback = args[1] ? evaluate(args[1], env) : undefined
    if (callback != undefined && typeof callback !== 'function')
      throw new TypeError(
        'Second argument of .: adjacent_find >> must be a -> []'
      )
  ...
  ['.:adjacent_find_index>>']: (args, env) => {
    if (args.length < 1 || args.length > 2)
      throw new RangeError(
        'Invalid number of arguments to .: adjacent_find_index >> []'
      )
    const array = evaluate(args[0], env)
    if (!Inventory.isBrrr(array))
      throw new TypeError(
        'First argument of .: adjacent_find_index >> must be an .: []'
      )
    const callback = args[1] ? evaluate(args[1], env) : undefined
    if (callback != undefined && typeof callback !== 'function')
      throw new TypeError(
        'Second argument of .: adjacent_find_index >> must be a -> []'
      )
